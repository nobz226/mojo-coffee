      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-2 mb-4">
            ...
            <span className="bg-gray-200 px-3 py-1">{product.roastType} Roast</span>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              {product.dietaryProfile.nonDairy && (
                <span className="bg-green-100 px-3 py-1 text-sm">Non-Dairy</span>
              )}
              {product.dietaryProfile.glutenFree && (
                <span className="bg-green-100 px-3 py-1 text-sm">Gluten Free</span>
              )}
            </div>
          </div>
          ...
          {/* Add to Cart */}
          {product.inStock ? (
            <button className="bg-blue-600 text-white px-8 py-3 w-full md:w-auto">
              Add to Cart
            </button>
          ) : (
            <button disabled className="bg-gray-300 text-gray-600 px-8 py-3 w-full md:w-auto cursor-not-allowed">
              Out of Stock
            </button>
          )}
